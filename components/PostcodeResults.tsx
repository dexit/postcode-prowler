  ...
  return (
    <div className="space-y-6 fade-in">
      ...
      {(api_data?.latitude !== undefined && api_data?.longitude !== undefined) && (
        <MapComponent latitude={api_data.latitude} longitude={api_data.longitude} />
      )}

      {/* Status card */}
      <div className="bg-gray-800 rounded-xl p-6 shadow-lg">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-white">Postcode Status</h2>
          <span className={`status-badge ${getStatusBadgeClass()}`}>{getStatusBadgeText()}</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-gray-400">Postcode</p>
            <p className="text-white font-medium">{asf.postcode ?? 'N/A'}</p>
          </div>
          <div>
            <p className="text-gray-400">Area</p>
            <p className="text-white font-medium">{asf.area_name ?? 'N/A'}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-white font-medium">{asf.source_name ?? 'N/A'}</p>
          </div>
        </div>
      </div>
      ...
      {/* Geography card */}
      <div className="bg-gray-800 rounded-xl p-6 shadow-lg">
        <h2 className="text-xl font-semibold text-white mb-4">Geographical Data</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-gray-400">Country</p>
            <p className="text-white font-medium">{api_data?.country ?? 'N/A'}</p>
          </div>
          <div>
            <p className="text-gray-400">Region</p>
            <p className="text-white font-medium">{api_data?.region ?? 'N/A'}</p>
          </div>
          <div>
          ...
          <div>
            <p className="text-gray-400">Termination Date</p>
            <p className="text-white font-medium">{terminationDate}</p>
          </div>
        </div>
      </div>
      ...
      {/* Administrative card */}
      <div className="bg-gray-800 rounded-xl p-6 shadow-lg">
        <h2 className="text-xl font-semibold text-white mb-4">Administrative Details</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-gray-400">District</p>
            <p className="text-white font-medium">{api_data?.admin_district ?? 'N/A'}</p>
          </div>
          <div>
            <p className="text-gray-400">Ward</p>
            <p className="text-white font-medium">{api_data?.admin_ward ?? 'N/A'}</p>
          </div>
          <div>
            <p className="text-gray-400">Constituency</p>
            <p className="text-white font-medium">{api_data?.parliamentary_constituency ?? 'N/A'}</p>
          </div>
          <div>
            <p className="text-gray-400">Parish</p>
            <p className="text-white font-medium">{api_data?.parish ?? 'N/A'}</p>
          </div>
        </div>
      </div>
    </div>
